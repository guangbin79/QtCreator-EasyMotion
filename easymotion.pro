...
QMAKE_LFLAGS += -Wl,-Bsymbolic -Wl,-s
CONFIG += hide_symbols
...
isEmpty(IDE_SOURCE_TREE): IDE_SOURCE_TREE = "/root/Downloads/qt-creator-opensource-src-4.5.2"

## Either set the IDE_BUILD_TREE when running qmake,
## or set the QTC_BUILD environment variable, to override the default setting
isEmpty(IDE_BUILD_TREE): IDE_BUILD_TREE = $$(QTC_BUILD)
isEmpty(IDE_BUILD_TREE): IDE_BUILD_TREE = "/root/Downloads/qt-creator-opensource-src-4.5.2"
